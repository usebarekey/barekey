 ...
 */
declare const IsOptIntoMiddleware: (context: AppLoadContext) => boolean;
declare const injectRequestStateIntoResponse: (response: Response, requestState: RequestStateWithRedirectUrls, context: AppLoadContext, includeClerkHeaders?: boolean) => Promise<Response>;
/**
