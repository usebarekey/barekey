...
function useListNavigation(context, props) {
  ...
  (0, _useIsoLayoutEffect.useIsoLayoutEffect)(() => {
    ...
    const activeEl = (0, _utils.activeElement)((0, _owner.ownerDocument)(floatingElement));
  ...
  const item = React.useMemo(() => {
    ...
    const itemProps = {
      ...
      onPointerLeave(event) {
        ...
        (0, _enqueueFocus.enqueueFocus)(null, {
          sync: true
        });
        indexRef.current = -1;
        onNavigate(event);
  ...
  const commonOnKeyDown = (0, _useStableCallback.useStableCallback)(event => {
    ...
    if (cols > 1) {
      ...
      const cellMap = (0, _utils.createGridCellMap)(sizes, cols, false);
