...
var Ti$1 = Reflect.get;
var an = (t) => {
	throw TypeError(t);
};
var ln = (t, e) => {
	for (var n in e) Ci$1(t, n, {
		get: e[n],
		enumerable: !0
	});
};
var nt$1 = (t, e, n) => e.has(t) || an("Cannot " + n);
var U$1 = (t, e, n) => (nt$1(t, e, "read from private field"), n ? n.call(t) : e.get(t)), ke$1 = (t, e, n) => e.has(t) ? an("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, n), st$1 = (t, e, n, s) => (nt$1(t, e, "write to private field"), s ? s.call(t, n) : e.set(t, n), n), v$1 = (t, e, n) => (nt$1(t, e, "access private method"), n);
var cn = (t, e, n) => Ti$1(_i$1(t), n, e);
var Ei$1 = {};
ln(Ei$1, { parsers: () => sn });
var sn = {};
ln(sn, {
...
function ue$1(t) {
	return t.type === "TSNonNullExpression" && !un(t) ? ue$1(t.expression) : (t.type === "OptionalCallExpression" || t.type === "OptionalMemberExpression") && !un(t);
}
...
function Ge$1(t, e) {
	return Ai$1(t, e, (n, s) => n.isEquivalent(s));
}
var S$1 = class {
	type;
	sourceSpan;
	...
	prop(e, n) {
		return new ht$1(this, e, null, n);
	}
	key(e, n, s) {
		return new ft$1(this, e, n, s);
	}
	callFn(e, n, s) {
		return new at$1(this, e, null, n, s);
	}
	instantiate(e, n, s) {
		return new lt$1(this, e, n, s);
	}
	conditional(e, n = null, s) {
		return new pt$1(this, e, n, null, s);
	}
	equals(e, n) {
		return new x(c$1.Equals, this, e, null, n);
	}
	notEquals(e, n) {
		return new x(c$1.NotEquals, this, e, null, n);
	}
	identical(e, n) {
		return new x(c$1.Identical, this, e, null, n);
	}
	notIdentical(e, n) {
		return new x(c$1.NotIdentical, this, e, null, n);
	}
	minus(e, n) {
		return new x(c$1.Minus, this, e, null, n);
	}
	plus(e, n) {
		return new x(c$1.Plus, this, e, null, n);
	}
	divide(e, n) {
		return new x(c$1.Divide, this, e, null, n);
	}
	multiply(e, n) {
		return new x(c$1.Multiply, this, e, null, n);
	}
	modulo(e, n) {
		return new x(c$1.Modulo, this, e, null, n);
	}
	power(e, n) {
		return new x(c$1.Exponentiation, this, e, null, n);
	}
	and(e, n) {
		return new x(c$1.And, this, e, null, n);
	}
	bitwiseOr(e, n) {
		return new x(c$1.BitwiseOr, this, e, null, n);
	}
	bitwiseAnd(e, n) {
		return new x(c$1.BitwiseAnd, this, e, null, n);
	}
	or(e, n) {
		return new x(c$1.Or, this, e, null, n);
	}
	lower(e, n) {
		return new x(c$1.Lower, this, e, null, n);
	}
	lowerEquals(e, n) {
		return new x(c$1.LowerEquals, this, e, null, n);
	}
	bigger(e, n) {
		return new x(c$1.Bigger, this, e, null, n);
	}
	biggerEquals(e, n) {
		return new x(c$1.BiggerEquals, this, e, null, n);
	}
	isBlank(e) {
		return this.equals(TYPED_NULL_EXPR, e);
	}
	nullishCoalesce(e, n) {
		return new x(c$1.NullishCoalesce, this, e, null, n);
	}
	toStmt() {
		return new wt$1(this, null);
	}
}, rt$1 = class t extends S$1 {
	name;
	constructor(e, n, s) {
	...
	set(e) {
		return new x(c$1.Assign, this, e, null, this.sourceSpan);
	}
}, ot$1 = class t extends S$1 {
	expr;
	constructor(e, n, s) {
...
var at$1 = class t extends S$1 {
	...
	isEquivalent(e) {
		return e instanceof t && this.fn.isEquivalent(e.fn) && Ge$1(this.args, e.args) && this.pure === e.pure;
	}
	isConstant() {
		return !1;
	}
...
var lt$1 = class t extends S$1 {
	...
	isEquivalent(e) {
		return e instanceof t && this.classExpr.isEquivalent(e.classExpr) && Ge$1(this.args, e.args);
	}
	isConstant() {
		return !1;
	}
...
var pt$1 = class t extends S$1 {
	...
	isEquivalent(e) {
		return e instanceof t && this.condition.isEquivalent(e.condition) && this.trueCase.isEquivalent(e.trueCase) && bi$1(this.falseCase, e.falseCase);
	}
	isConstant() {
		return !1;
	}
...
var x = class t extends S$1 {
	...
	isAssignment() {
		let e = this.operator;
		return e === c$1.Assign || e === c$1.AdditionAssignment || e === c$1.SubtractionAssignment || e === c$1.MultiplicationAssignment || e === c$1.DivisionAssignment || e === c$1.RemainderAssignment || e === c$1.ExponentiationAssignment || e === c$1.AndAssignment || e === c$1.OrAssignment || e === c$1.NullishCoalesceAssignment;
	}
}, ht$1 = class t extends S$1 {
	receiver;
	name;
	constructor(e, n, s, i) {
	...
	set(e) {
		return new x(c$1.Assign, this.receiver.prop(this.name), e, null, this.sourceSpan);
	}
	clone() {
		return new t(this.receiver.clone(), this.name, this.type, this.sourceSpan);
	}
}, ft$1 = class t extends S$1 {
	receiver;
	index;
	constructor(e, n, s, i) {
	...
	set(e) {
		return new x(c$1.Assign, this.receiver.key(this.index), e, null, this.sourceSpan);
	}
	clone() {
		return new t(this.receiver.clone(), this.index.clone(), this.type, this.sourceSpan);
	}
}, dt$1 = class t extends S$1 {
	entries;
	constructor(e, n, s) {
	...
	isEquivalent(e) {
		return e instanceof t && Ge$1(this.entries, e.entries);
	}
	visitExpression(e, n) {
...
(class t {
	...
	keyOf(e) {
		if (e instanceof Ne$1 && typeof e.value == "string") return `"${e.value}"`;
		if (e instanceof Ne$1) return String(e.value);
		if (e instanceof ct$1) return `/${e.body}/${e.flags ?? ""}`;
		if (e instanceof dt$1) {
			let n = [];
			for (let s of e.entries) n.push(this.keyOf(s));
			return `[${n.join(",")}]`;
		} else if (e instanceof gt$1) {
			let n = [];
			for (let s of e.entries) if (s instanceof mt$1) n.push("..." + this.keyOf(s.expression));
			else {
				let i = s.key;
			...
			if (e instanceof ut$1) return `import("${e.value.moduleName}", ${e.value.name})`;
			if (e instanceof rt$1) return `read(${e.name})`;
			if (e instanceof ot$1) return `typeof(${this.keyOf(e.expr)})`;
			if (e instanceof vt$1) return `...${this.keyOf(e.expression)}`;
...
new Map([
	...
	[c$1.Plus, "+"],
	[c$1.In, "in"],
	[c$1.AdditionAssignment, "+="],
	[c$1.SubtractionAssignment, "-="],
	[c$1.MultiplicationAssignment, "*="],
	[c$1.DivisionAssignment, "/="],
	[c$1.RemainderAssignment, "%="],
	[c$1.ExponentiationAssignment, "**="],
	[c$1.AndAssignment, "&&="],
	[c$1.OrAssignment, "||="],
	[c$1.NullishCoalesceAssignment, "??="]
]);
var Tn;
(function(t) {
...
var X$1 = class {
	...
	toAbsolute(e) {
		return new $$1(e + this.start, e + this.end);
	}
}, g$1 = class {
	span;
	sourceSpan;
...
}, Se$1 = class extends g$1 {
	nameSpan;
	constructor(e, n, s) {
		super(e, n), this.nameSpan = s;
	}
}, b$1 = class extends g$1 {
	visit(e, n = null) {}
}, ne$1 = class extends g$1 {
	visit(e, n = null) {
		return e.visitImplicitReceiver(this, n);
	}
}, Et$1 = class extends g$1 {
	visit(e, n = null) {
		return e.visitThisReceiver?.(this, n);
	}
}, yt$1 = class extends g$1 {
	expressions;
	constructor(e, n, s) {
...
}, O$1 = class extends g$1 {
	ast;
	source;
	location;
	errors;
	constructor(e, n, s, i, r) {
		super(new X$1(0, n === null ? 0 : n.length), new $$1(i, n === null ? i : i + n.length)), this.ast = e, this.source = n, this.location = s, this.errors = r;
	}
	visit(e, n = null) {
...
var pe$1 = 0;
var os$1 = 9, Ie$1 = 10, Ni$1 = 11, Pi$1 = 12, Li$1 = 13, as$1 = 32, Mi$1 = 33, ls$1 = 34, Ri$1 = 35, Wt$1 = 36, $i$1 = 37, In = 38, cs$1 = 39, ve$1 = 40, q$1 = 41, Nn = 42, us$1 = 43, Q$1 = 44, ps$1 = 45, H$1 = 46, Fe$1 = 47, j$1 = 58, fe$1 = 59, Di$1 = 60, k = 61, Bi$1 = 62, Pn = 63, Oi = 48;
var Fi$1 = 57, qt$1 = 65, Vi$1 = 69;
var jt$1 = 90, te$1 = 91, it$1 = 92, G$1 = 93, Ui$1 = 94, Xe$1 = 95, hs$1 = 97;
var Hi$1 = 101, Wi$1 = 102, qi$1 = 110, ji$1 = 114, zi$1 = 116, Gi$1 = 117, Xi$1 = 118;
var fs$1 = 122, Ve$1 = 123, Ln = 124, K$1 = 125, ds$1 = 160;
var $t$1 = 96;
function Ji$1(t) {
	return t >= os$1 && t <= as$1 || t == ds$1;
}
function W$1(t) {
	return Oi <= t && t <= Fi$1;
}
function Dt$1(t) {
	return t >= hs$1 && t <= fs$1 || t >= qt$1 && t <= jt$1;
}
function Mn(t) {
	return t === cs$1 || t === ls$1 || t === $t$1;
}
var Ue$1 = class t {
	file;
	offset;
	...
	moveBy(e) {
		...
		for (; i > 0 && e < 0;) if (i--, e++, n.charCodeAt(i) == Ie$1) {
			r--;
			let p = n.substring(0, i - 1).lastIndexOf(String.fromCharCode(Ie$1));
			a = p > 0 ? i - p : i;
		} else a--;
		for (; i < s && e > 0;) {
...
var Yi$1 = "(:(where|is)\\()?", ms$1 = "-shadowcsshost", Qi$1 = "-shadowcsscontext", Bt$1 = "[^)(]*", zt$1 = `(?:\\((${`(?:\\(${`(?:\\(${Bt$1}\\)|${Bt$1})+?`}\\)|${Bt$1})+?`})\\))`;
new RegExp("(:nth-[-\\w]+)" + zt$1, "g");
new RegExp(ms$1 + zt$1 + "?([^,{]*)", "gim");
var er$1 = Qi$1 + zt$1 + "?([^{]*)";
new RegExp(`${Yi$1}(${er$1})`, "gim");
var tr$1 = ms$1 + "-no-combinator";
new RegExp(`${tr$1}(?![^(]*\\))`, "g");
var gs$1 = "%COMMENT%";
new RegExp(gs$1, "g");
new RegExp(`(\\s*(?:${gs$1}\\s*)*)([^;\\{\\}]+?)(\\s*)((?:{%BLOCK%}?\\s*;?)|(?:\\s*;))`, "g");
var nr$1 = "%COMMA_IN_PLACEHOLDER%", sr$1 = "%SEMI_IN_PLACEHOLDER%", ir$1 = "%COLON_IN_PLACEHOLDER%";
new RegExp(nr$1, "g");
new RegExp(sr$1, "g");
new RegExp(ir$1, "g");
var f;
...
var lr$1 = [
	...
	isTemplateLiteralPart() {
		return this.isString() && this.kind === F$1.TemplateLiteralPart;
	}
	isTemplateLiteralEnd() {
		return this.isString() && this.kind === F$1.TemplateLiteralEnd;
	}
...
var Ae$1 = new A(-1, -1, h.Character, 0, ""), Ft$1 = class {
	input;
	tokens = [];
	length;
	peek = 0;
	...
	advance() {
		this.peek = ++this.index >= this.length ? pe$1 : this.input.charCodeAt(this.index);
	}
	scanToken() {
		...
		if (W$1(s)) return this.scanNumber(i);
		let r = i;
		switch (s) {
			case H$1: return this.advance(), W$1(this.peek) ? this.scanNumber(r) : this.peek !== H$1 ? he$1(r, this.index, H$1) : (this.advance(), this.peek === H$1 ? (this.advance(), Y$1(r, this.index, "...")) : this.error(`Unexpected character [${String.fromCharCode(s)}]`, 0));
			case ve$1:
			case q$1:
			case te$1:
			case G$1:
			case Q$1:
			case j$1:
			case fe$1: return this.scanCharacter(r, s);
			case Ve$1: return this.scanOpenBrace(r, s);
			case K$1: return this.scanCloseBrace(r, s);
			case cs$1:
			case ls$1: return this.scanString();
			case $t$1: return this.advance(), this.scanTemplateLiteralPart(r);
			case Ri$1: return this.scanPrivateIdentifier();
			case us$1: return this.scanComplexOperator(r, "+", k, "=");
			case ps$1: return this.scanComplexOperator(r, "-", k, "=");
			case Fe$1: return this.isStartOfRegex() ? this.scanRegex(i) : this.scanComplexOperator(r, "/", k, "=");
			case $i$1: return this.scanComplexOperator(r, "%", k, "=");
			case Ui$1: return this.scanOperator(r, "^");
			case Nn: return this.scanStar(r);
			case Pn: return this.scanQuestion(r);
			case Di$1:
			case Bi$1: return this.scanComplexOperator(r, String.fromCharCode(s), k, "=");
			case Mi$1:
			...
			case ds$1:
				for (; Ji$1(this.peek);) this.advance();
				return this.scanToken();
		}
		return this.advance(), this.error(`Unexpected character [${String.fromCharCode(s)}]`, 0);
	}
	scanCharacter(e, n) {
		return this.advance(), he$1(e, this.index, n);
	}
	scanOperator(e, n) {
		return this.advance(), Y$1(e, this.index, n);
	}
	scanOpenBrace(e, n) {
		return this.braceStack.push("expression"), this.advance(), he$1(e, this.index, n);
	}
	scanCloseBrace(e, n) {
		return this.advance(), this.braceStack.pop() === "interpolation" ? (this.tokens.push(he$1(e, this.index, K$1)), this.scanTemplateLiteralPart(this.index)) : he$1(e, this.index, n);
	}
	scanComplexOperator(e, n, s, i, r, a) {
		this.advance();
		let u = n;
		return this.peek == s && (this.advance(), u += i), r != null && this.peek == r && (this.advance(), u += a), Y$1(e, this.index, u);
	}
	scanIdentifier() {
		let e = this.index;
		for (this.advance(); es$1(this.peek);) this.advance();
		let n = this.input.substring(e, this.index);
		return lr$1.indexOf(n) > -1 ? pr$1(e, this.index, n) : cr$1(e, this.index, n);
	}
	scanPrivateIdentifier() {
		let e = this.index;
		if (this.advance(), !Zn(this.peek)) return this.error("Invalid character [#]", -1);
		for (; es$1(this.peek);) this.advance();
		let n = this.input.substring(e, this.index);
		return ur$1(e, this.index, n);
	}
	scanNumber(e) {
		let n = this.index === e, s = !1;
		for (this.advance();;) {
			if (!W$1(this.peek)) if (this.peek === Xe$1) {
				if (!W$1(this.input.charCodeAt(this.index - 1)) || !W$1(this.input.charCodeAt(this.index + 1))) return this.error("Invalid numeric separator", 0);
				s = !0;
			} else if (this.peek === H$1) n = !1;
			else if (gr$1(this.peek)) {
				if (this.advance(), vr$1(this.peek) && this.advance(), !W$1(this.peek)) return this.error("Invalid exponent", -1);
				n = !1;
			} else break;
			this.advance();
		}
		...
		s && (i = i.replace(/_/g, ""));
		let r = n ? wr$1(i) : parseFloat(i);
		return hr$1(e, this.index, r);
	}
	scanString() {
		let e = this.index, n = this.peek;
		this.advance();
		let s = "", i = this.index, r = this.input;
		for (; this.peek != n;) if (this.peek == it$1) {
			let u = this.scanStringBackslash(s, i);
			if (typeof u != "string") return u;
			s = u, i = this.index;
		} else {
			if (this.peek == pe$1) return this.error("Unterminated quote", 0);
			this.advance();
		}
		let a = r.substring(i, this.index);
		return this.advance(), new xe$1(e, this.index, s + a, F$1.Plain);
	}
	scanQuestion(e) {
		this.advance();
		let n = "?";
		return this.peek === Pn ? (n += "?", this.advance(), this.peek === k && (n += "=", this.advance())) : this.peek === H$1 && (n += ".", this.advance()), Y$1(e, this.index, n);
	}
	scanTemplateLiteralPart(e) {
		let n = "", s = this.index;
		for (; this.peek !== $t$1;) if (this.peek === it$1) {
			let r = this.scanStringBackslash(n, s);
			if (typeof r != "string") return r;
			n = r, s = this.index;
		} else if (this.peek === Wt$1) {
			let r = this.index;
			if (this.advance(), this.peek === Ve$1) return this.braceStack.push("interpolation"), this.tokens.push(new xe$1(e, r, n + this.input.substring(s, r), F$1.TemplateLiteralPart)), this.advance(), Y$1(r, this.index, this.input.substring(r, this.index));
		} else {
			if (this.peek === pe$1) return this.error("Unterminated template literal", 0);
			this.advance();
		}
		let i = this.input.substring(s, this.index);
		return this.advance(), new xe$1(e, this.index, n + i, F$1.TemplateLiteralEnd);
	}
	error(e, n) {
		let s = this.index + n;
	...
	scanStringBackslash(e, n) {
		...
		let s;
		if (this.advance(), this.peek === Gi$1) {
	...
	scanStar(e) {
		this.advance();
		let n = "*";
		return this.peek === Nn ? (n += "*", this.advance(), this.peek === k && (n += "=", this.advance())) : this.peek === k && (n += "=", this.advance()), Y$1(e, this.index, n);
	}
	isStartOfRegex() {
		...
		if (e.isOperator("!")) {
			...
			return n === null || n.type !== h.Identifier && !n.isCharacter(q$1) && !n.isCharacter(G$1);
		}
		return e.type === h.Operator || e.isCharacter(ve$1) || e.isCharacter(te$1) || e.isCharacter(Q$1) || e.isCharacter(j$1);
	}
	scanRegex(e) {
		this.advance();
		...
		for (;;) {
			let p = this.peek;
			if (p === pe$1) return this.error("Unterminated regular expression", 0);
			if (s) s = !1;
			else if (p === it$1) s = !0;
			else if (p === te$1) i = !0;
			else if (p === G$1) i = !1;
			else if (p === Fe$1 && !i) break;
			this.advance();
		}
		let r = this.input.substring(n, this.index);
		this.advance();
		let a = dr$1(e, this.index, r), u = this.scanRegexFlags(this.index);
		return u !== null ? (this.tokens.push(a), u) : a;
	}
	scanRegexFlags(e) {
		if (!Dt$1(this.peek)) return null;
		for (; Dt$1(this.peek);) this.advance();
		return mr(e, this.index, this.input.substring(e, this.index));
	}
};
function Zn(t) {
	return hs$1 <= t && t <= fs$1 || qt$1 <= t && t <= jt$1 || t == Xe$1 || t == Wt$1;
}
function es$1(t) {
	return Dt$1(t) || W$1(t) || t == Xe$1 || t == Wt$1;
}
function gr$1(t) {
	return t == Hi$1 || t == Vi$1;
}
function vr$1(t) {
	return t == ps$1 || t == us$1;
}
function xr(t) {
	switch (t) {
		case qi$1: return Ie$1;
		case Wi$1: return Pi$1;
		case ji$1: return Li$1;
		case zi$1: return os$1;
		case Xi$1: return Ni$1;
		default: return t;
	}
}
function wr$1(t) {
...
var oe$1 = class {
	...
	parseAction(e, n, s) {
		...
		return new O$1(new z$1(e, n, s, this._lexer.tokenize(r), 1, i, 0, this._supportsDirectPipeReferences).parseChain(), e, B$1(n), s, i);
	}
	parseBinding(e, n, s) {
		let i = [];
		return new O$1(this._parseBindingAst(e, n, s, i), e, B$1(n), s, i);
	}
	...
	parseSimpleBinding(e, n, s) {
		...
		return a.length > 0 && i.push(ee$1(`Host binding expression cannot contain ${a.join(" ")}`, e, "", n)), new O$1(r, e, B$1(n), s, i);
	}
	_parseBindingAst(e, n, s, i) {
		this._checkNoInterpolation(i, e, n);
		let { stripped: r } = this._stripComments(e);
		return new z$1(e, n, s, this._lexer.tokenize(r), 0, i, 0, this._supportsDirectPipeReferences).parseChain();
	}
	parseTemplateBindings(e, n, s, i, r) {
		return new z$1(n, s, r, this._lexer.tokenize(n), 0, [], 0, this._supportsDirectPipeReferences).parseTemplateBindings({
			source: e,
			span: new $$1(i, i + e.length)
		});
	}
	parseInterpolation(e, n, s, i) {
		...
		for (let w = 0; w < u.length; ++w) {
			...
			if (y && T.trim().length === 0 && V.length === 0) {
				r.push(ee$1("Interpolation expression cannot only contain a comment", e, `at column ${u[w].start} in`, n));
				continue;
			}
			let ce = new z$1(D ? _ : e, D || n, s, V, 0, r, p[w], this._supportsDirectPipeReferences).parseChain();
			d.push(ce);
		}
		return this.createInterpolationAst(a.map((w) => w.text), d, e, B$1(n), s, r);
	}
	parseInterpolationExpression(e, n, s) {
		let { stripped: i } = this._stripComments(e), r = this._lexer.tokenize(i), a = [], u = new z$1(e, n, s, r, 0, a, 0, this._supportsDirectPipeReferences).parseChain();
		return this.createInterpolationAst(["", ""], [u], e, B$1(n), s, a);
	}
	createInterpolationAst(e, n, s, i, r, a) {
		let u = new X$1(0, s.length);
		return new O$1(new Ii$1(u, u.toAbsolute(r), e, n), s, i, r, a);
	}
	splitInterpolation(e, n, s, i) {
		let r = [], a = [], u = [], p = i ? Sr$1(i) : null, d = 0, w = !1, D = !1, _ = "{{", T = "}}";
		for (; d < e.length;) if (w) {
			...
			on.trim().length === 0 && s.push(ee$1("Blank expressions are not allowed in interpolated strings", e, `at column ${d} in`, n)), a.push({
				text: on,
				start: y,
				end: rn
			});
		...
		return new Vt$1(r, a, u);
	}
	wrapLiteralPrimitive(e, n, s) {
		let i = new X$1(0, e == null ? 0 : e.length);
		return new O$1(new I(i, i.toAbsolute(s), e), e, typeof n == "string" ? n : B$1(n), s, []);
	}
	_stripComments(e) {
	...
	_commentStart(e) {
		...
		for (let s = 0; s < e.length - 1; s++) {
			...
			if (i === Fe$1 && r == Fe$1 && n == null) return s;
	...
	_checkNoInterpolation(e, n, s) {
		...
		i > -1 && r > -1 && e.push(ee$1("Got interpolation ({{}}) where expression was expected", n, `at column ${i} in`, s));
	}
...
var ts$1 = new Set([
	...
	peek(e) {
		let n = this.index + e;
		return n < this.tokens.length ? this.tokens[n] : Ae$1;
	}
	get next() {
		return this.peek(0);
	}
	...
	isAssignmentOperator(e) {
		return e.type === h.Operator && E$1.isAssignmentOperation(e.strValue);
	}
	expectOperator(e) {
		this.consumeOptionalOperator(e) || this.error(`Missing expected operator ${e}`);
	}
	prettyPrintToken(e) {
		return e === Ae$1 ? "end of input" : `token ${e}`;
	}
	...
	parseChain() {
		...
		for (; this.index < this.tokens.length;) {
			...
			if (e.push(s), this.consumeOptionalCharacter(fe$1)) for (this.parseFlags & 1 || this.error("Binding expression cannot contain chained expression"); this.consumeOptionalCharacter(fe$1););
		...
		if (e.length === 0) {
			...
			return new b$1(this.span(s, i), this.sourceSpan(s, i));
		}
		return e.length == 1 ? e[0] : new yt$1(this.span(n), this.sourceSpan(n), e);
	}
	parsePipe() {
		...
		if (this.consumeOptionalOperator("|")) {
			...
			do {
				...
				i !== null ? r = this.sourceSpan(s) : (i = "", a = this.next.index !== -1 ? this.next.index : this.input.length + this.offset, r = new X$1(a, a).toAbsolute(this.absoluteOffset));
				let u = [];
				for (; this.consumeOptionalCharacter(j$1);) u.push(this.parseExpression());
				let p;
				if (this.supportsDirectPipeReferences) {
					let d = i.charCodeAt(0);
					p = d === Xe$1 || d >= qt$1 && d <= jt$1 ? me$1.ReferencedDirectly : me$1.ReferencedByName;
				} else p = me$1.ReferencedByName;
				n = new kt$1(this.span(e), this.sourceSpan(e, a), n, i, u, p, r);
	...
	parseConditional() {
		...
		if (this.consumeOptionalOperator("?")) {
			...
			if (this.consumeOptionalCharacter(j$1)) i = this.parsePipe();
			else {
				let r = this.inputIndex, a = this.input.substring(e, r);
				this.error(`Conditional expression ${a} requires all 3 expressions`), i = new b$1(this.span(e), this.sourceSpan(e));
			}
			return new Ct$1(this.span(e), this.sourceSpan(e), n, s, i);
		} else return n;
	}
	parseLogicalOr() {
		...
		for (; this.consumeOptionalOperator("||");) {
			...
			n = new E$1(this.span(e), this.sourceSpan(e), "||", n, s);
		}
		return n;
	}
	parseLogicalAnd() {
		...
		for (; this.next.type == h.Operator;) {
			...
			switch (s) {
				...
				case "!==":
					...
					n = new E$1(this.span(e), this.sourceSpan(e), s, n, i);
					continue;
			}
			break;
		}
	...
	parseExponentiation() {
		...
		for (; this.next.type == h.Operator && this.next.strValue === "**";) {
			(n instanceof ge$1 || n instanceof Me$1 || n instanceof Re$1 || n instanceof $e$1) && this.error("Unary operator used immediately before exponentiation expression. Parenthesis must be used to disambiguate operator precedence"), this.advance();
	...
	parsePrefix() {
		if (this.next.type == h.Operator) {
			...
			switch (n) {
				case "+": return this.advance(), s = this.parsePrefix(), ge$1.createPlus(this.span(e), this.sourceSpan(e), s);
				case "-": return this.advance(), s = this.parsePrefix(), ge$1.createMinus(this.span(e), this.sourceSpan(e), s);
				case "!": return this.advance(), s = this.parsePrefix(), new Me$1(this.span(e), this.sourceSpan(e), s);
			}
		} else if (this.next.isKeywordTypeof()) {
			let e = this.inputIndex;
			this.advance();
			let n = this.parsePrefix();
			return new Re$1(this.span(e), this.sourceSpan(e), n);
		} else if (this.next.isKeywordVoid()) {
			let e = this.inputIndex;
			this.advance();
			let n = this.parsePrefix();
			return new $e$1(this.span(e), this.sourceSpan(e), n);
		}
		return this.parseCallChain();
	}
	parseCallChain() {
		let e = this.inputIndex, n = this.parsePrimary();
		for (;;) if (this.consumeOptionalCharacter(H$1)) n = this.parseAccessMember(n, e, !1);
		else if (this.consumeOptionalOperator("?.")) this.consumeOptionalCharacter(ve$1) ? n = this.parseCall(n, e, !0) : n = this.consumeOptionalCharacter(te$1) ? this.parseKeyedReadOrWrite(n, e, !0) : this.parseAccessMember(n, e, !0);
		else if (this.consumeOptionalCharacter(te$1)) n = this.parseKeyedReadOrWrite(n, e, !1);
		else if (this.consumeOptionalCharacter(ve$1)) n = this.parseCall(n, e, !1);
		else if (this.consumeOptionalOperator("!")) n = new Nt$1(this.span(e), this.sourceSpan(e), n);
	...
	parsePrimary() {
		let e = this.inputIndex;
		if (this.consumeOptionalCharacter(ve$1)) {
			this.rparensExpected++;
			let n = this.parsePipe();
			return this.consumeOptionalCharacter(q$1) || (this.error("Missing closing parentheses"), this.consumeOptionalCharacter(q$1)), this.rparensExpected--, new Ee$1(this.span(e), this.sourceSpan(e), n);
		} else {
			...
			if (this.next.isKeywordThis()) return this.advance(), new Et$1(this.span(e), this.sourceSpan(e));
			if (this.consumeOptionalCharacter(te$1)) return this.parseLiteralArray(e);
			if (this.next.isCharacter(Ve$1)) return this.parseLiteralMap();
			if (this.next.isIdentifier()) return this.parseAccessMember(new ne$1(this.span(e), this.sourceSpan(e)), e, !1);
			if (this.next.isNumber()) {
				...
				if (this.next.isString() && this.next.kind === F$1.Plain) {
					let n = this.next.toString();
					return this.advance(), new I(this.span(e), this.sourceSpan(e), n);
				} else return this.next.isPrivateIdentifier() ? (this._reportErrorForPrivateIdentifier(this.next, null), new b$1(this.span(e), this.sourceSpan(e))) : this.next.isRegExpBody() ? this.parseRegularExpressionLiteral() : this.index >= this.tokens.length ? (this.error(`Unexpected end of expression: ${this.input}`), new b$1(this.span(e), this.sourceSpan(e))) : (this.error(`Unexpected token ${this.next}`), new b$1(this.span(e), this.sourceSpan(e)));
			}
		}
	}
	parseLiteralArray(e) {
		...
		do
			...
			else if (!this.next.isCharacter(G$1)) n.push(this.parsePipe());
			else break;
		while (this.consumeOptionalCharacter(Q$1));
		return this.rbracketsExpected--, this.expectCharacter(G$1), new bt$1(this.span(e), this.sourceSpan(e), n);
	}
	parseLiteralMap() {
		let e = [], n = [], s = this.inputIndex;
		if (this.expectCharacter(Ve$1), !this.consumeOptionalCharacter(K$1)) {
			...
			do {
				...
				e.push(d), r ? (this.expectCharacter(j$1), n.push(this.parsePipe())) : this.consumeOptionalCharacter(j$1) ? n.push(this.parsePipe()) : (d.isShorthandInitialized = !0, n.push(new de$1(u, p, p, new ne$1(u, p), a)));
			} while (this.consumeOptionalCharacter(Q$1) && !this.next.isCharacter(K$1));
			this.rbracesExpected--, this.expectCharacter(K$1);
		}
		return new It$1(this.span(s), this.sourceSpan(s), e, n);
	}
	parseAccessMember(e, n, s) {
		let i = this.inputIndex, r = this.withContext(Z$1.Writable, () => {
			let u = this.expectIdentifierOrKeyword() ?? "";
			return u.length === 0 && this.error("Expected identifier for property access", e.span.end), u;
		}), a = this.sourceSpan(i);
		if (s) return this.isAssignmentOperator(this.next) ? (this.advance(), this.error("The '?.' operator cannot be used in the assignment"), new b$1(this.span(n), this.sourceSpan(n))) : new _t$1(this.span(n), this.sourceSpan(n), a, e, r);
		if (this.isAssignmentOperator(this.next)) {
			let u = this.next.strValue;
			if (!(this.parseFlags & 1)) return this.advance(), this.error("Bindings cannot contain assignments"), new b$1(this.span(n), this.sourceSpan(n));
			let p = new de$1(this.span(n), this.sourceSpan(n), a, e, r);
			this.advance();
			let d = this.parseConditional();
			return new E$1(this.span(n), this.sourceSpan(n), u, p, d);
		} else return new de$1(this.span(n), this.sourceSpan(n), a, e, r);
	}
	parseCall(e, n, s) {
		let i = this.inputIndex;
		this.rparensExpected++;
		let r = this.parseCallArguments(), a = this.span(i, this.inputIndex).toAbsolute(this.absoluteOffset);
		this.expectCharacter(q$1), this.rparensExpected--;
		let u = this.span(n), p = this.sourceSpan(n);
		return s ? new Lt$1(u, p, e, r, a) : new Pt$1(u, p, e, r, a);
	}
	parseCallArguments() {
		if (this.next.isCharacter(q$1)) return [];
		let e = [];
		do
	...
	parseSpreadElement() {
		...
		this.advance();
		let n = this.parsePipe();
		return new At$1(this.span(e), this.sourceSpan(e), n);
	}
	...
	parseTemplateBindings(e) {
		...
		return new Ut$1(n, [], this.errors);
	}
	parseKeyedReadOrWrite(e, n, s) {
		return this.withContext(Z$1.Writable, () => {
			this.rbracketsExpected++;
			let i = this.parsePipe();
			if (i instanceof b$1 && this.error("Key access cannot be empty"), this.rbracketsExpected--, this.expectCharacter(G$1), this.isAssignmentOperator(this.next)) {
				let r = this.next.strValue;
				if (s) this.advance(), this.error("The '?.' operator cannot be used in the assignment");
				else {
					let a = new Le$1(this.span(n), this.sourceSpan(n), e, i);
					this.advance();
					let u = this.parseConditional();
					return new E$1(this.span(n), this.sourceSpan(n), r, a, u);
				}
			} else return s ? new Tt$1(this.span(n), this.sourceSpan(n), e, i) : new Le$1(this.span(n), this.sourceSpan(n), e, i);
			return new b$1(this.span(n), this.sourceSpan(n));
		});
	}
	parseDirectiveKeywordBindings(e) {
		let n = [];
		this.consumeOptionalCharacter(j$1);
		...
		let a = new $$1(e.span.start, i);
		return n.push(new ye$1(a, e, s)), r && n.push(r), n;
	}
	getDirectiveBoundTarget() {
		if (this.next === Ae$1 || this.peekKeywordAs() || this.peekKeywordLet()) return null;
		let e = this.parsePipe(), { start: n, end: s } = e.span;
		return new O$1(e, this.input.substring(n, s), B$1(this.parseSourceSpan), this.absoluteOffset + n, this.errors);
	}
	parseAsBinding(e) {
		...
		this.consumeStatementTerminator();
		return new se$1(new $$1(e.span.start, this.currentAbsoluteOffset), n, e);
	}
	parseLetBinding() {
	...
	parseTemplateLiteral() {
		...
		for (; this.next !== Ae$1;) {
			...
			if (i.isTemplateLiteralPart() || i.isTemplateLiteralEnd()) {
				...
				if (this.advance(), e.push(new Oe$1(this.span(r), this.sourceSpan(r), i.strValue)), i.isTemplateLiteralEnd()) break;
			} else if (i.isTemplateLiteralInterpolationStart()) {
				this.advance(), this.rbracesExpected++;
				let r = this.parsePipe();
				r instanceof b$1 ? this.error("Template literal interpolation cannot be empty") : n.push(r), this.rbracesExpected--;
			} else this.advance();
		}
		return new Be$1(this.span(s), this.sourceSpan(s), e, n);
	}
	parseRegularExpressionLiteral() {
		let e = this.next;
		if (this.advance(), !e.isRegExpBody()) return new b$1(this.span(this.inputIndex), this.sourceSpan(this.inputIndex));
		let n = null;
		if (this.next.isRegExpFlags()) {
			...
			for (let a = 0; a < n.strValue.length; a++) {
				let u = n.strValue[a];
				ts$1.has(u) ? r.has(u) ? this.error(`Duplicate regular expression flag "${u}"`, n.index + a) : r.add(u) : this.error(`Unsupported regular expression flag "${u}". The supported flags are: ` + Array.from(ts$1, (p) => `"${p}"`).join(", "), n.index + a);
			}
		}
		let s = e.index, i = n ? n.end : e.end;
		return new Mt$1(this.span(s, i), this.sourceSpan(s, i), e.strValue, n ? n.strValue : null);
	}
	consumeStatementTerminator() {
		this.consumeOptionalCharacter(fe$1) || this.consumeOptionalCharacter(Q$1);
	}
	error(e, n = this.index) {
		this.errors.push(ee$1(e, this.input, this.getErrorLocationText(n), this.parseSourceSpan)), this.skip();
	}
	...
	skip() {
		let e = this.next;
		for (; this.index < this.tokens.length && !e.isCharacter(fe$1) && !e.isOperator("|") && (this.rparensExpected <= 0 || !e.isCharacter(q$1)) && (this.rbracesExpected <= 0 || !e.isCharacter(K$1)) && (this.rbracketsExpected <= 0 || !e.isCharacter(G$1)) && (!(this.context & Z$1.Writable) || !this.isAssignmentOperator(e));) this.next.isError() && this.errors.push(ee$1(this.next.toString(), this.input, this.getErrorLocationText(this.next.index), this.parseSourceSpan)), this.advance(), e = this.next;
	}
};
function ee$1(t, e, n, s) {
	n.length > 0 && (n = ` ${n} `);
	let i = B$1(s);
	return new Ce$1(s, `Parser Error: ${t}${n}[${e}] in ${i}`);
}
var Ht$1 = class extends Rt$1 {
	errors = [];
	visitPipe() {
...
function we$1(t, e) {
	return (n) => n.kind === t && e === n.expression instanceof je$1;
}
P$1(f.StyleMap), P$1(f.ClassMap), P$1(f.StyleProp), P$1(f.ClassProp), we$1(f.Attribute, !0), we$1(f.Property, !0), we$1(f.Attribute, !1), P$1(f.Control);
we$1(f.DomProperty, !0), we$1(f.DomProperty, !1), P$1(f.Attribute), P$1(f.StyleMap), P$1(f.ClassMap), P$1(f.StyleProp), P$1(f.ClassProp);
new Set([
	f.Listener,
	f.TwoWayListener,
	f.AnimationListener,
...
new Map([
	[L$1.Property, M$1.Property],
	[L$1.TwoWay, M$1.TwoWayProperty],
	[L$1.Attribute, M$1.Attribute],
	[L$1.Class, M$1.ClassName],
	[L$1.Style, M$1.StyleProperty],
	[L$1.LegacyAnimation, M$1.LegacyAnimation],
	[L$1.Animation, M$1.Animation]
]);
var ss$1;
(function(t) {
...
var Cr$1 = "test.html";
function Ss$1(t) {
	let e = new He$1(t, Cr$1), n = new Ue$1(e, 0, 0, 0), s = n.moveBy(t.length);
	return {
		text: t,
		file: e,
		start: n,
		end: s,
		sourceSpan: new We$1(n, s)
	};
}
var _r$1;
function Es$1() {
	return _r$1 ?? (_r$1 = new oe$1(new _e$1()));
}
var Tr$1 = (t) => oe$1.prototype._commentStart(t);
function kr$1(t) {
	let e = Tr$1(t);
	return e === null ? [] : [{
		type: "CommentLine",
...
var Je$1 = (t) => (e) => {
	...
	return ys$1({
		...n,
		result: Es$1()[t](e, n.sourceSpan, 0),
		comments: kr$1(e)
	});
}, Cs$1 = Je$1("parseAction"), _s$1 = Je$1("parseBinding"), Ts$1 = Je$1("parseSimpleBinding"), ks$1 = Je$1("parseInterpolationExpression"), bs$1 = (t) => {
	let e = Ss$1(t);
	return ys$1({
		...e,
		result: Es$1().parseTemplateBindings("", t, e.sourceSpan, 0, 0),
		comments: []
	});
};
var Ye$1 = class {
...
var As$1 = Object.defineProperty, Is$1 = (t, e) => {
	let n = {};
	for (var s in t) As$1(n, s, {
		get: t[s],
		enumerable: !0
	});
	return e && As$1(n, Symbol.toStringTag, { value: "Module" }), n;
};
var Ns$1 = (t, e) => ({
	type: "ArrayExpression",
	elements: e.transformChildren(t.expressions)
});
var Ps$1 = (t, e) => e.transformChild(t.ast);
var br$1 = (t) => t === "&&" || t === "||" || t === "??", Ls$1 = (t, e) => {
...
var Ar$1 = { optional: !1 }, Ir$1 = { optional: !0 }, Ms$1 = ({ optional: t }) => (e, n) => {
...
var Nr$1 = {
	...
	computed: !1,
	optional: !0
}, Qe$1 = ({ computed: t, optional: e }) => (n, s) => {
	let { receiver: i } = n, r;
	if (t) {
		let { key: u } = n;
		r = s.transformChild(u);
	} else {
		let u = i instanceof ne$1, { name: p, nameSpan: d } = n;
		if (r = s.create({
			type: "Identifier",
			name: p
...
}, Us$1 = Qe$1(Nr$1), Hs$1 = Qe$1(Pr), Ws$1 = Qe$1(Lr), qs$1 = Qe$1(Mr$1);
var js$1 = (t, e) => ({
...
var Gs$1 = (t, e) => e.transformChild(t.expression);
var Xs$1 = (t, e) => ({
...
var Zs$1 = () => ({ type: "ThisExpression" });
var Xt$1 = (t) => (e, n) => ({
	type: "UnaryExpression",
	prefix: !0,
	operator: t,
	argument: n.transformChild(e.expression)
}), ei$1 = Xt$1("!"), ti$1 = Xt$1("typeof"), ni$1 = Xt$1("void"), si$1 = (t, e) => ({
	type: "UnaryExpression",
	prefix: !0,
...
var oi$1 = Is$1({
	visitASTWithSource: () => Ps$1,
	visitBinary: () => Ls$1,
	visitCall: () => Rs$1,
	visitChain: () => Ds$1,
	visitConditional: () => Bs$1,
	visitImplicitReceiver: () => ii$1,
	visitInterpolation: () => Os$1,
	visitKeyedRead: () => Us$1,
	visitLiteralArray: () => Ns$1,
	visitLiteralMap: () => zs$1,
	visitLiteralPrimitive: () => Fs$1,
	visitNonNullAssert: () => js$1,
	visitParenthesizedExpression: () => Gs$1,
	visitPipe: () => Xs$1,
	visitPrefixNot: () => ei$1,
	visitPropertyRead: () => Ws$1,
	visitRegularExpressionLiteral: () => Vs$1,
	visitSafeCall: () => $s$1,
	visitSafeKeyedRead: () => Hs$1,
	visitSafePropertyRead: () => qs$1,
	visitSpreadElement: () => Js$1,
	visitTaggedTemplateLiteral: () => Ys$1,
	visitTemplateLiteral: () => Qs$1,
	visitTemplateLiteralElement: () => Ks$1,
	visitThisReceiver: () => Zs$1,
	visitTypeofExpression: () => ti$1,
	visitUnary: () => si$1,
	visitVoidExpression: () => ni$1
});
var Ke$1 = class Jt extends Ye$1 {
	node;
	ancestors;
	...
	create(e, n, s = this.ancestors) {
		return s[0] instanceof Ee$1 && (e.extra = {
			...e.extra,
			parenthesized: !0
	...
	transform() {
		let { node: e } = this;
		if (e instanceof b$1) return this.create({ type: "NGEmptyExpression" });
		let n = e.visit(oi$1, this);
...
var li$1 = (t, e) => Ke$1.transform(t, e), ci$1 = (t) => new ai$1(t).transform();
var ui$1 = (t, e) => (n, s, ...i) => n | 1 && s == null ? void 0 : (e.call(s) ?? s[t]).apply(s, i);
function $r$1(t) {
	return this[t < 0 ? this.length + t : t];
}
var pi$1 = ui$1("at", function() {
	if (Array.isArray(this) || typeof this == "string") return $r$1;
});
function hi$1(t) {
	return t instanceof ye$1;
}
function fi$1(t) {
	return t instanceof se$1;
}
var ae, J$1, m$1, di$1, C, Yt$1, Qt$1, Kt$1, mi$1, gi$1, vi$1, xi$1, le$1, Br$1 = (le$1 = class extends Ye$1 {
	constructor(n, s) {
		super(s);
		ke$1(this, m$1);
		ke$1(this, ae);
		ke$1(this, J$1);
		st$1(this, ae, n), st$1(this, J$1, s);
		for (let i of n) v$1(this, m$1, mi$1).call(this, i);
	}
	get expressions() {
		return v$1(this, m$1, vi$1).call(this);
	}
}, ae = /* @__PURE__ */ new WeakMap(), J$1 = /* @__PURE__ */ new WeakMap(), m$1 = /* @__PURE__ */ new WeakSet(), di$1 = function() {
	return U$1(this, ae)[0].key;
}, C = function(n, s) {
	return cn(le$1.prototype, this, "createNode").call(this, n, s);
}, Yt$1 = function(n) {
	return li$1(n, this.text);
}, Qt$1 = function(n) {
	return hn(n.slice(U$1(this, m$1, di$1).source.length));
}, Kt$1 = function(n) {
	let s = U$1(this, J$1);
	...
	v$1(this, m$1, Kt$1).call(this, n.key.span), fi$1(n) && n.value && v$1(this, m$1, Kt$1).call(this, n.value.span);
}, gi$1 = function(n) {
	...
	let n = U$1(this, ae), [s] = n, i = U$1(this, J$1).slice(s.sourceSpan.start, s.sourceSpan.end).trim().length === 0 ? n.slice(1) : n, r = [], a = null;
	for (let [u, p] of i.entries()) {
		if (a && hi$1(a) && fi$1(p) && p.value && p.value.source === a.key.source) {
			let d = v$1(this, m$1, C).call(this, {
		...
		} else r.push(v$1(this, m$1, xi$1).call(this, p, u));
		a = p;
	}
	return v$1(this, m$1, C).call(this, {
		type: "NGMicrosyntax",
		body: r
	...
	if (hi$1(n)) {
		let { key: i, value: r } = n;
		return r ? s === 0 ? v$1(this, m$1, C).call(this, {
			type: "NGMicrosyntaxExpression",
			expression: v$1(this, m$1, Yt$1).call(this, r.ast),
			alias: null
		}, r) : v$1(this, m$1, C).call(this, {
			type: "NGMicrosyntaxKeyedExpression",
			key: v$1(this, m$1, C).call(this, {
				type: "NGMicrosyntaxKey",
				name: v$1(this, m$1, Qt$1).call(this, i.source)
			}, i.span),
			expression: v$1(this, m$1, C).call(this, {
				type: "NGMicrosyntaxExpression",
				expression: v$1(this, m$1, Yt$1).call(this, r.ast),
				alias: null
			}, r)
		}, [i.span.start, r.sourceSpan.end]) : v$1(this, m$1, C).call(this, {
			type: "NGMicrosyntaxKey",
			name: v$1(this, m$1, Qt$1).call(this, i.source)
		}, i.span);
	} else {
		let { key: i, sourceSpan: r } = n;
		if (/^let\s$/.test(U$1(this, J$1).slice(r.start, r.start + 4))) {
			let { value: a } = n;
			return v$1(this, m$1, C).call(this, {
				...
				value: a ? v$1(this, m$1, C).call(this, {
					type: "NGMicrosyntaxKey",
					name: a.source
				}, a.span) : null
			}, [r.start, a ? a.span.end : i.span.end]);
		} else {
			let a = v$1(this, m$1, gi$1).call(this, n);
			return v$1(this, m$1, C).call(this, {
				...
				alias: v$1(this, m$1, C).call(this, {
					type: "NGMicrosyntaxKey",
					name: i.source
				}, i.span)
...
function wi$1(t, e) {
	return new Br$1(t, e).expressions;
}
var Ze$1 = (t) => (e) => {
	let { result: n, comments: s } = t(e);
	return Object.assign(ci$1(n), { comments: s });
}, et$1 = Ze$1(Cs$1), Zt$1 = Ze$1(_s$1);
Ze$1(Ts$1);
var en = Ze$1(ks$1), tn = (t) => wi$1(bs$1(t).result.templateBindings, t);
function nn(t) {
...
function tt$1(t) {
	return {
		...
		parse(e) {
			...
			return delete n.comments, t === et$1 && n.type !== "NGChainedExpression" && (n = {
				...n,
				type: "NGChainedExpression",
				expressions: [n]
			}), {
...
function transformCss(ast, env) {
	function tryParseAtRuleParams(name, params) {
		...
		try {
			return en$1.css.parse(`@import ${params};`, { ...env.options }).nodes[0].params;
		} catch (err) {
...
const { parsers, printers } = createPlugin([
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./html-D2VbMQAT.js")
		}],
	...
	defineTransform({
		...
		load: [{
			...
			importer: () => import("./glimmer-B28TNYIB.js")
		}],
		parsers: { glimmer: {} },
	...
	defineTransform({
		...
		parsers: {
			...
			typescript: { load: [{
				...
				importer: () => import("./typescript-D5lCjM2U.js")
			}] },
			meriyah: { load: [{
				name: "prettier/plugins/meriyah",
				importer: () => import("./meriyah-CQnZTN4N.js")
			}] },
			acorn: { load: [{
				name: "prettier/plugins/acorn",
				importer: () => import("./acorn-DSYDYt2u.js")
			}] },
			flow: { load: [{
				name: "prettier/plugins/flow",
				importer: () => import("./flow-DZRswbuH.js")
			}] },
			oxc: { load: [{
