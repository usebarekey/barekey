...
>
	<CommandPicker.Item
		...
		label="Deno"
		icon="deno"
		command="deno add --node-modules-dir=auto --allow-scripts=npm:@barekey/memorystore npm:@barekey/memorystore"
	/>
	...
	<CommandPicker.Item
		...
		label="pnpm"
		icon="pnpm"
		command="pnpm add --allow-build=@barekey/memorystore @barekey/memorystore"
	/>
	<CommandPicker.Item
		value="npm"
		label="npm"
