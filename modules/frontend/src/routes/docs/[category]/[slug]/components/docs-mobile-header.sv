...
<header
	class="sticky top-2 z-20 order-first flex h-12 w-full shrink-0 items-center justify-between rounded-full border border-white/18 bg-linear-to-b from-white/18 to-white/8 px-2 pl-3 shadow-[inset_0_1px_0_oklch(1_0_0_/_16%),0_10px_30px_-18px_oklch(0_0_0_/_70%)] backdrop-blur-xl xl:hidden"
>
